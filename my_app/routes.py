    ...
    if request.method == 'POST':
        ...
        if user and user.confirmed == False:
            try:
                ...
                msg = Message("myRoute Email Verification", sender="frankizu.site", recipients=[email])
...
def signup():
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            try:
                msg = Message("myRoute Email Verification", sender="admin@redr.site", recipients=[email])
